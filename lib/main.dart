...
import 'package:register_kidsclub/screen/loadface.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StartPage() // ShowFace(bg: 'en',cardCode: '',checkFace:'1',mask: '1',rfid: '',selectColor: '1',selectZone: '',sex: 'M',)
    );
  }
}
